...
camErr.s = 0;                               %no skew
camErr.pU1 = 0*(0.68e-3)^2;                 %mm min resolution is 1.38um
camErr.pU2 = 0*(0.68e-3)^2;                 %mm min res is 1.38um
camErr.pV1 = 0*(0.68e-3)^2;                 %mm min res is 1.38um
camErr.pV2 = 0*(0.68e-3)^2;                 %mm min res is 1.38um
...
simNumErr = vpa(simSub)                             % numerical error for simple model in mm
...
genNumErr = vpa(genSub)                             % numerical error for general model in mm
