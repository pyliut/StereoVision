...
d_start = 500;                                        % object distance (mm) start value
d_end = 5000;                                        % end value
d_step = 500;                                          % difference between values
...
text(gen_d(minIndex_d),gen_f(minIndex_f),minError,'Minimum error = ' + string(minError) + ' mm '...
...
savefig('fig_f_d_theta90_Gen')     %save    
