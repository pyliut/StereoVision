...
cam.d = 500;
cam.theta = pi/2;
cam.u1 = 0;                %mm assuming each pixel is 2um
cam.u2 = 0;
cam.v1 = 0;
cam.v2 = 0;
% general
...
cam.alphaV = 1;
cam.s = 0;                          
cam.pU1 = 0*0.7e-3*2;                %mm assuming each pixel is 2um
cam.pU2 = 0*0.7e-3*2;
cam.pV1 = 0*0.7e-3*2;
cam.pV2 = 0*0.7e-3*2;
...
camErr.f = (0.01)^2;                     %mm
camErr.d = (0.01)^2;                     %mm
camErr.theta = (pi/(180))^2;             %radians
camErr.u1 = (0.7e-3)^2;                  %mm min res is 1.38um
camErr.u2 = (0.7e-3)^2;                  %mm min res is 1.38um
camErr.v1 = (0.7e-3)^2;                  %mm min res is 1.38um
camErr.v2 = (0.7e-3)^2;                  %mm min res is 1.38um
% general
camErr.alphaU = 0;                  %mm
camErr.alphaV = 0;
camErr.s = 0;                               %no skew
camErr.pU1 = 0*(0.7e-3)^2;                 %mm min resolution is 1.38um
camErr.pU2 = 0*(0.7e-3)^2;                 %mm min res is 1.38um
camErr.pV1 = 0*(0.7e-3)^2;                 %mm min res is 1.38um
camErr.pV2 = 0*(0.7e-3)^2;                 %mm min res is 1.38um
