...
closestText = 'Min error = ' + string(closestError*1000) + 'um @ f = ' + string(gen_f(closestIndex)) + 'mm';
...
title('General Model - Variation of f , theta = ' + string(cam.theta) + ' rad '+ ', d = '+ string(cam.d) + ' mm '+ ', pixelWidth = '+ string(pixelWidth) + ' mm ' ... 
...
text(gen_f(closestIndex)*0.9,closestError*1.5,closestText,'FontSize',font-8)
text(gen_f(closestIndex)*0.9,closestError*0.5,HFOVText,'FontSize',font-8)

savefig('f_varGenGraph_1b')     %save    
