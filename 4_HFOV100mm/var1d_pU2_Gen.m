...
closestError = gen_err(closestIndex);
    ...
    %++++++++++++++CHANGE MARKER++++++++++++++
closestText = 'Min error = ' + string(closestError*1000) + 'um @ pU2 = ' + string(gen_p(closestIndex)) + 'pixels';
...
plot(gen_p,gen_err,'LineWidth',lineWidth);                       %plot
    ...
    %+++++++++++CHANGE TITLE+++++++++++++++
xlabel('Pixel position, pU2 (mm)','FontSize',font); ylabel('Error (mm)','FontSize',font); 
title('General Model - Variation of pU2 , theta = ' + string(cam.theta) + ' rad '+ ', f = '+ string(cam.f) + ' mm '...
