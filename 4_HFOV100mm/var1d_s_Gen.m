...
closestError = gen_err(closestIndex);
    ...
    %++++++++++++++CHANGE MARKER++++++++++++++
closestText = 'Min error = ' + string(closestError*1000) + 'um @ s = ' + string(gen_s(closestIndex)) ;
...
plot(gen_s,gen_err,'LineWidth',lineWidth);                       %plot
...
hold on
plot(gen_s(closestIndex),closestError,'rx','MarkerSize',font,'LineWidth',lineWidth)
text(gen_s(closestIndex)*0.9,closestError*0.9,closestText,'FontSize',font-8)
