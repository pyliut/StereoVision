...
closestError = gen_err(closestIndex);
    ...
    %++++++++++++++CHANGE MARKER++++++++++++++
closestText = 'Min error = ' + string(closestError*1000) + 'um @ u2 = ' + string(gen_u2(closestIndex)) + 'pixels';
...
plot(gen_u2,gen_err,'LineWidth',lineWidth);                       %plot
...
hold on
plot(gen_u2(closestIndex),closestError,'rx','MarkerSize',font,'LineWidth',lineWidth)
text(gen_u2(closestIndex)*0.9,closestError*0.9,closestText,'FontSize',font-8)
