...
closestError = gen_err(closestIndex);
    ...
    %++++++++++++++CHANGE MARKER++++++++++++++
closestText = 'Min error = ' + string(closestError*1000) + 'um @ v1 = ' + string(gen_v1(closestIndex)) + 'pixels';
...
plot(gen_v1,gen_err,'LineWidth',lineWidth);                       %plot
...
hold on
plot(gen_v1(closestIndex),closestError,'rx','MarkerSize',font,'LineWidth',lineWidth)
text(gen_v1(closestIndex)*0.9,closestError*0.9,closestText,'FontSize',font-8)
