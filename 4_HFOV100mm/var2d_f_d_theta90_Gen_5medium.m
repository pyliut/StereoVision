...
title('General Model - medium format, theta = ' + string(cam.theta) + ' rad '+ ', pixelWidth = '+ string(pixelWidth) + ' mm ' ... 
...
savefig('fig_f_d_theta90_Gen_5medium')     %save    
