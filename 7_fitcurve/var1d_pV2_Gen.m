...
closestError = gen_err(closestIndex);
    ...
    %++++++++++++++CHANGE MARKER++++++++++++++
closestText = 'Min error = ' + string(closestError*1000) + 'um @ pV2 = ' + string(gen_p(closestIndex)) + 'pixels';
...
coordText = '(' + string(cam.u1/pixelWidth) + ',' +string(cam.u2/pixelWidth) + ',' +string(cam.v1/pixelWidth) + ',' +string(cam.v2/pixelWidth) ...
    ...
    %+++++++++++CHANGE TITLE+++++++++++++++
xlabel('Pixel position, pV2 (mm)','FontSize',font); ylabel('Error (mm)','FontSize',font); 
title('General Model - Variation of pV2 , theta = ' + string(cam.theta) + ' rad '+ ', f = '+ string(cam.f) + ' mm '...
