function [genSolX,genSolY,genSolZ] = generalWorldPointsTest(genK1,genK2,genK3,extrinsics1,extrinsics2,extrinsics3)
...
% Solve
    [genSolX,genSolY,genSolZ] = solve(genEqn1,genEqn3,genEqn6,genX,genY,genZ);
