...
ylabel('Error (mm)','FontSize',font);xlabel('Pixel scaling factor, alphaU','FontSize',font); 
title('Variation of alphaU, f = ' + string(cam.f) + 'mm'+ ', d = ' + string(cam.d) + 'mm' + ', theta = ' + string(cam.theta*180/pi)...
