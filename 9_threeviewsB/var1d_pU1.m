...
p_step = 100*pixelWidth;                                          % difference between values
...
ylabel('Error (mm)','FontSize',font);xlabel('Principle coord, pU1 (pixels)','FontSize',font); 
title('Variation of pU1, f = ' + string(cam.f) + 'mm'+ ', d = ' + string(cam.d) + 'mm' + ', theta = ' + string(cam.theta*180/pi)...
