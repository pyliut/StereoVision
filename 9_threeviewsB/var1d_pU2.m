...
ylabel('Error (mm)','FontSize',font);xlabel('Principle coord, pU2 (pixels)','FontSize',font); 
title('Variation of pU2, f = ' + string(cam.f) + 'mm'+ ', d = ' + string(cam.d) + 'mm' + ', theta = ' + string(cam.theta*180/pi)...
