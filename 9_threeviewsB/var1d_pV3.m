...
ylabel('Error (mm)','FontSize',font);xlabel('Principle coord, pV3 (pixels)','FontSize',font); 
title('Variation of pV3, f = ' + string(cam.f) + 'mm'+ ', d = ' + string(cam.d) + 'mm' + ', theta = ' + string(cam.theta*180/pi)...
