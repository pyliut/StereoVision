...
u_step = 20*pixelWidth;                                          % difference between values
...
ylabel('Error (mm)','FontSize',font);xlabel('Image coord, u1 (pixels)','FontSize',font); 
title('Variation of u1, f = ' + string(cam.f) + 'mm'+ ', d = ' + string(cam.d) + 'mm' + ', theta = ' + string(cam.theta*180/pi)...
