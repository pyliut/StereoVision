...
ylabel('Error (mm)','FontSize',font);xlabel('Image coord, v1 (pixels)','FontSize',font); 
title('Variation of v1, f = ' + string(cam.f) + 'mm'+ ', d = ' + string(cam.d) + 'mm' + ', theta = ' + string(cam.theta*180/pi)...
