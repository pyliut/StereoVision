...
ylabel('Error (mm)','FontSize',font);xlabel('Image coord, v2 (pixels)','FontSize',font); 
title('Variation of v2, f = ' + string(cam.f) + 'mm'+ ', d = ' + string(cam.d) + 'mm' + ', theta = ' + string(cam.theta*180/pi)...
