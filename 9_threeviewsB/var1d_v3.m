...
u_step = 10*pixelWidth;                                          % difference between values
...
ylabel('Error (mm)','FontSize',font);xlabel('Image coord, v3 (pixels)','FontSize',font); 
title('Variation of v3, f = ' + string(cam.f) + 'mm'+ ', d = ' + string(cam.d) + 'mm' + ', theta = ' + string(cam.theta*180/pi)...
